...
import { getBookedRoom } from "../../../Api/AdminApi"
...
export default function BookDetails() {
  ...
  const getRoom = async (Id) => {
    ...
    const Room = data[0]
    console.log(Room,"1234567890");
    setRoom(Room)
  }
  console.log(room,"enthenllam aahn ollath");
    ...
    <>
      ...
      <div class="flex justify-center p-4 leading-normal">
        ...
        <p class="mb-2 text-2xl text-center font-normal tracking-tight ml-2">
          ...
          Checkin Date:{room.checkin}<br />
          CheckOut Date:{room.checkout}<br />
